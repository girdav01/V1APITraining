...
def main():
    try:
        ...
        #tmconfig.zone
        x = TMVisionOne.XDR("us", tmconfig.xdr_token, "Trend Micro Vision One CollectFile.py sample")
...
if __name__ == '__main__':
    ...
    print("""V1CollectFile.py -e CA-DAVEG-L -f "c:\data\winword.exe" -d "collect test file" """)
    print('\nTo retrieve a file, wait for the file to be ready and use task number like this')
    print("V1CollectFile.py -r 00000338 -i 1")
